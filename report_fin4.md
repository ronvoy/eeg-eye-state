...
The bandpass is implemented as a cascade of highpass ($f_L$ = 0.5 Hz) and lowpass ($f_H$ = 45.0 Hz) Butterworth stages:

$$|H(j\omega)|^2 = \frac{1}{1 + \left(\frac{\omega_c}{\omega^2 - \omega_0^2}\right)^{2N}}$$

where $\omega_0 = \sqrt{\omega_L \cdot \omega_H}$ and $N$ = 4 is the filter order. Because spikes have already been removed, `filtfilt` operates on a clean signal and will not spread artifact energy to adjacent samples.
...
| band_Gamma_power | 30–45 Hz | 4.0462 | 2.9543 |
...
After IQR filtering on feature space: **8225** samples retained (removed 5381).
...
| --- | --- | --- | --- |
| LDA (1D) | 0.1285 | 1.6280 | 1926.32 |
| t-SNE (2D) | 0.0022 | 21.1146 | 9.46 |
| UMAP (2D) | 0.0015 | 15.5786 | 17.09 |
...
- **Best Silhouette Score:** LDA (1D) (0.1285)
- **Best Davies-Bouldin Index:** LDA (1D) (1.6280)
- **Best Calinski-Harabasz Score:** LDA (1D) (1926.32)
...
Acc=0.5987 | MacroF1=0.3973 | BinaryF1=0.0488 | AUC=0.3736 | Threshold=0.64 | TrainTime=36.9s
...
Acc=0.6781 | MacroF1=0.4316 | BinaryF1=0.0574 | AUC=0.3968 | Threshold=0.65 | TrainTime=29.9s
...
Acc=0.5169 | MacroF1=0.3710 | BinaryF1=0.0681 | AUC=0.4011 | Threshold=0.67 | TrainTime=0.6s
...
Acc=0.6102 | MacroF1=0.4170 | BinaryF1=0.0814 | AUC=0.4691 | Threshold=0.71 | TrainTime=27.0s
...
Acc=0.6242 | MacroF1=0.4200 | BinaryF1=0.0759 | AUC=0.4339 | Threshold=0.71 | TrainTime=25.4s
...
Acc=0.5918 | MacroF1=0.4149 | BinaryF1=0.0931 | AUC=0.5097 | Threshold=0.81 | TrainTime=0.5s
...
Acc=0.9214 | MacroF1=0.4795 | BinaryF1=0.0000 | AUC=0.3734 | Threshold=0.84 | TrainTime=48.0s
...
Acc=0.9155 | MacroF1=0.5251 | BinaryF1=0.0945 | AUC=0.4217 | Threshold=0.79 | TrainTime=34.5s
...
Acc=0.9133 | MacroF1=0.5015 | BinaryF1=0.0484 | AUC=0.3974 | Threshold=0.95 | TrainTime=0.6s
...
Expanding-window walk-forward CV simulates real deployment: the model always trains on all available past data before predicting the next window. Future data never leaks into training. A fixed threshold of 0.5 is used for unbiased evaluation (threshold tuning on the same fold would inflate scores).

Fold 1 — train=6803 | val=1133 | val_closed=100.00%

  LogisticRegression: Acc=0.5128 MacroF1=0.3390 AUC=nan t=0.50

  SVM_RBF: Acc=0.5975 MacroF1=0.3740 AUC=nan t=0.50

  RandomForest: Acc=0.6628 MacroF1=0.3986 AUC=nan t=0.50

  GradientBoosting: Acc=0.6258 MacroF1=0.3849 AUC=nan t=0.50

  XGBoost: Acc=0.6205 MacroF1=0.3829 AUC=nan t=0.50

Fold 2 — train=7936 | val=1133 | val_closed=41.92%

  LogisticRegression: Acc=0.5022 MacroF1=0.5004 AUC=0.5059 t=0.50

  SVM_RBF: Acc=0.5560 MacroF1=0.5435 AUC=0.6512 t=0.50

  RandomForest: Acc=0.4978 MacroF1=0.4685 AUC=0.5905 t=0.50

  GradientBoosting: Acc=0.5049 MacroF1=0.4851 AUC=0.5849 t=0.50

  XGBoost: Acc=0.5260 MacroF1=0.5212 AUC=0.5851 t=0.50

Fold 3 — train=9069 | val=1133 | val_closed=0.97%

  LogisticRegression: Acc=0.5199 MacroF1=0.3594 AUC=0.9927 t=0.50

  SVM_RBF: Acc=0.3857 MacroF1=0.2905 AUC=0.9308 t=0.50

  RandomForest: Acc=0.2577 MacroF1=0.2130 AUC=0.9952 t=0.50

  GradientBoosting: Acc=0.2966 MacroF1=0.2380 AUC=0.9987 t=0.50

  XGBoost: Acc=0.3416 MacroF1=0.2653 AUC=0.9665 t=0.50

Fold 4 — train=10202 | val=1133 | val_closed=60.19%

  LogisticRegression: Acc=0.4810 MacroF1=0.4711 AUC=0.4801 t=0.50

  SVM_RBF: Acc=0.5340 MacroF1=0.5053 AUC=0.4896 t=0.50

  RandomForest: Acc=0.5375 MacroF1=0.5128 AUC=0.4911 t=0.50

  GradientBoosting: Acc=0.5296 MacroF1=0.5101 AUC=0.4962 t=0.50

  XGBoost: Acc=0.5428 MacroF1=0.5230 AUC=0.5206 t=0.50

Fold 5 — train=11335 | val=1133 | val_closed=8.03%

  LogisticRegression: Acc=0.5322 MacroF1=0.4294 AUC=0.6395 t=0.50

  SVM_RBF: Acc=0.4095 MacroF1=0.3440 AUC=0.5345 t=0.50

  RandomForest: Acc=0.3883 MacroF1=0.3353 AUC=0.5356 t=0.50

  GradientBoosting: Acc=0.4210 MacroF1=0.3531 AUC=0.5334 t=0.50

  XGBoost: Acc=0.3919 MacroF1=0.3293 AUC=0.4580 t=0.50
...
| SVM_RBF | 0.4115±0.0967 | 0.4966±0.0837 | 0.5212±0.3025 |
| RandomForest | 0.3857±0.1054 | 0.4688±0.1373 | 0.5225±0.3169 |
| GradientBoosting | 0.3942±0.0978 | 0.4756±0.1108 | 0.5226±0.3176 |
| XGBoost | 0.4043±0.1031 | 0.4846±0.1026 | 0.5060±0.3088 |
...
Fold 1 — train=6803 | val=1133 | val_closed=100.00%
  ...
  SVM_RBF: Acc=0.5975 MacroF1=0.3740 AUC=nan

  RandomForest: Acc=0.6628 MacroF1=0.3986 AUC=nan

  GradientBoosting: Acc=0.6258 MacroF1=0.3849 AUC=nan

  XGBoost: Acc=0.6205 MacroF1=0.3829 AUC=nan

Fold 2 — train=6803 | val=1133 | val_closed=41.92%

  LogisticRegression: Acc=0.4996 MacroF1=0.4968 AUC=0.5073

  SVM_RBF: Acc=0.5375 MacroF1=0.5259 AUC=0.6490

  RandomForest: Acc=0.4925 MacroF1=0.4580 AUC=0.5911

  GradientBoosting: Acc=0.5110 MacroF1=0.4921 AUC=0.5874

  XGBoost: Acc=0.5084 MacroF1=0.4991 AUC=0.5836

Fold 3 — train=6803 | val=1133 | val_closed=0.97%

  LogisticRegression: Acc=0.5172 MacroF1=0.3582 AUC=0.8947

  SVM_RBF: Acc=0.2674 MacroF1=0.2172 AUC=0.4537

  RandomForest: Acc=0.1650 MacroF1=0.1470 AUC=0.5692

  GradientBoosting: Acc=0.2145 MacroF1=0.1828 AUC=0.6174

  XGBoost: Acc=0.2674 MacroF1=0.2179 AUC=0.5269

Fold 4 — train=6803 | val=1133 | val_closed=60.19%

  LogisticRegression: Acc=0.4846 MacroF1=0.4782 AUC=0.4971

  SVM_RBF: Acc=0.5552 MacroF1=0.5294 AUC=0.5082

  RandomForest: Acc=0.5613 MacroF1=0.5381 AUC=0.5281

  GradientBoosting: Acc=0.5428 MacroF1=0.5208 AUC=0.5278

  XGBoost: Acc=0.5287 MacroF1=0.5097 AUC=0.5244

Fold 5 — train=6803 | val=1133 | val_closed=8.03%

  LogisticRegression: Acc=0.5357 MacroF1=0.4240 AUC=0.6111

  SVM_RBF: Acc=0.4060 MacroF1=0.3449 AUC=0.5425

  RandomForest: Acc=0.3460 MacroF1=0.3078 AUC=0.5039

  GradientBoosting: Acc=0.3813 MacroF1=0.3262 AUC=0.4993

  XGBoost: Acc=0.3963 MacroF1=0.3407 AUC=0.5199

**Sliding-Window CV — Mean ± Std:**

| Model | MacroF1 Mean±Std | Acc Mean±Std | AUC Mean±Std |
| --- | --- | --- | --- |
| LogisticRegression | 0.4192±0.0627 | 0.5100±0.0172 | 0.5021±0.2892 |
| SVM_RBF | 0.3983±0.1181 | 0.4727±0.1210 | 0.4307±0.2246 |
| RandomForest | 0.3699±0.1345 | 0.4455±0.1740 | 0.4384±0.2213 |
| GradientBoosting | 0.3813±0.1218 | 0.4551±0.1437 | 0.4464±0.2271 |
| XGBoost | 0.3901±0.1080 | 0.4643±0.1215 | 0.4310±0.2167 |
...
where $w_c = \frac{N}{2 \cdot N_c}$ is the per-class weight and $z_c$ are the raw logits from the final linear layer (2 output units). This is `nn.CrossEntropyLoss` (softmax + negative log-likelihood). **Sequence length:** SEQ_LEN=64 samples (≈500ms at 128 Hz). **Optimizer:** AdamW, lr=1e-3, weight_decay=1e-4. **Scheduler:** CosineAnnealingLR over 25 epochs.
...
EEGNet (Lawhern et al. 2018) uses depthwise-separable 2D convolutions that explicitly model temporal patterns (Block 1 temporal kernel ≈ 250ms) and cross-electrode spatial patterns (Block 1 depthwise spatial filter). Only ~1.1K parameters — highly resistant to overfitting on limited data.
...
- **EEGNet** achieves the best single-split Macro-F1 (0.4977 on 70/15/15).
- **LogisticRegression** is the most robust ML model on the hardest 60/20/20 split (Macro-F1 = 0.4812).
...
| --- | --- | --- |
| Balanced accuracy (research) | EEGNet | Highest mean Macro-F1 (0.4964), best AUC across splits |
...
| Worst-case distribution shift | LogisticRegression | Best ML performance under severe concept drift |
